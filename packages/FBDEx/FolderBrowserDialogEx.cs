...
namespace FolderBrowserDialogEx
{
    public class FBDEx
    {
        ...
        public string RootFolder
        {
            set
            {
                rootfolder = Win32.ILCreateFromPathW(value);
            }
        }
        ...
        public struct InitData
        {
            ...
            public InitData(FBDEx dlg, IntPtr hParent)
            {
        ...
        public DialogResult ShowDialog(IWin32Window owner)
        {
            ...
            if (this.ShowFiles) bi.ulFlags |= Win32.BIF_BROWSEINCLUDEFILES; 
            if (this.ShowEditbox) bi.ulFlags |= Win32.BIF_EDITBOX;
            if (!this.ShowNewFolderButton) bi.ulFlags |= Win32.BIF_NONEWFOLDERBUTTON;
